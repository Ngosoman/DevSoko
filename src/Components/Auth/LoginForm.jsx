          ...
          <div className="relative">
            ...
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} stroke={showPassword ? "M15 12a3 3 0 11-6 0 3 3 0 016 0z" : "M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 11-4.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 21.414v0M21 3v0l-8.586 8.586m0 0L21 21.414v0m0 0l-8.586-8.586"} />
              </svg>
            </button>
          </div>
        </div>
